...
const LanguageSwitcher = ({ currentLang, onLanguageChange, isOpen, onToggle, buttonRef, contentRef, useDarkIcons }) => {
  const languages = [
  ...
  return (
    <div className="hidden md:block relative">
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={onToggle}
        className={`flex items-center gap-1 p-2.5 rounded-full hover:bg-white/10 transition-all text-sm ${
